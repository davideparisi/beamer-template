...
\newcommand\emailampersat{{\texorpdfstring{\color{stonered}}\small@}}
\catcode`\_=8\relax

% Display a titlebox
\newmdenv[tikzsetting={fill=white,fill opacity=0.7},
      backgroundcolor=none,leftmargin=0,rightmargin=40,innertopmargin=4pt,roundcorner=5pt]
      {titleBox}
\newmdenv[linecolor=stonered,frametitle=infobox,roundcorner=3pt,outerlinewidth=0.2pt]{infobox}
